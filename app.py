...
def load_model_cached():
    return tf.keras.models.load_model(r'C:\Users\User\OneDrive\Desktop\covid_19_model.h5')
...
with tabs[2]:
    ...
    - **Email**: [ahmednigme@gmail.com](mailto:ahmednigme@gmail.com)
    - **LinkedIn**: [Our LinkedIn](https://www.linkedin.com/in/ahmed-nigm/)
    - **GitHub**: [Our GitHub](https://github.com/Ahmed-Nigm)
    """)
